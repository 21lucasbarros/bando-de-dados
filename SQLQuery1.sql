...
select * from Livro l full join Categoria c on l.cd_categoria = c.cd_categoria

SELECT Autor.nm_autor, Livro.nm_titulo from Livro INNER JOIN Autor ON Livro.cd_autor = Autor.cd_autor

SELECT Categoria.nm_categoria, Livro.nm_titulo from Categoria LEFT JOIN Livro ON Categoria.cd_categoria = Livro.cd_categoria